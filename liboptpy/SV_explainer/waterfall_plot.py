...
def waterfall(shap_values, max_display=10, show=True, tick_mark_expectation="\n$E[f(X)]$", tick_mark_prediction="$f(x)$"):
    ...
    ax2.set_xticklabels([tick_mark_expectation, "\n$= " + format_value(base_values, "%0.02f") + "$"], fontsize=12, ha="center")
    ...
    ax3.set_xticklabels([tick_mark_prediction, "               $ = " + format_value(fx, "%0.02f") + "$"], fontsize=12, ha="center")
