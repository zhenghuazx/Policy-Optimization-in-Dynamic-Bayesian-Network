...
if __name__ == '__main__':
    ...
    beta_gibbs = pd.read_csv \
        ('/Users/hua.zheng/Research/PHD/project/BN-MDP/BN/beta_s5a1-R15-explore0.3-v1-modelrisk--ntime36-sigma10.txt', header=None, dtype=np.float64)
    v2_gibbs = pd.read_csv \
        ('/Users/hua.zheng/Research/PHD/project/BN-MDP/BN/v2_s5a1-R15-explore0.3-v1-modelrisk--ntime36-sigma10.txt', header=None,
                           dtype=np.float64)
    the_R = pd.read_csv \
        ('/Users/hua.zheng/Research/PHD/project/BN-MDP/BN/the_R_s5a1-R15-explore0.3-v1-modelrisk--ntime36-sigma10.txt', header=None, dtype=np.float64)
    tau2_R = pd.read_csv \
        ('/Users/hua.zheng/Research/PHD/project/BN-MDP/BN/tau2_R_s5a1-R15-explore0.3-v1-modelrisk--ntime36-sigma10.txt', header=None, dtype=np.float64)
    kap_R = pd.read_csv \
        ('/Users/hua.zheng/Research/PHD/project/BN-MDP/BN/kap_R_s5a1-R15-explore0.3-v1-modelrisk--ntime36-sigma10.txt', header=None, dtype=np.float64)
    lam_R = pd.read_csv \
        ('/Users/hua.zheng/Research/PHD/project/BN-MDP/BN/lam_R_s5a1-R15-explore0.3-v1-modelrisk--ntime36-sigma10.txt', header=None, dtype=np.float64)
    mu = pd.read_csv \
        ('/Users/hua.zheng/Research/PHD/project/BN-MDP/BN/mu_s5a1-R15-explore0.3-v1-modelrisk--ntime36-sigma10.txt', header=None, dtype=np.float64)
    sd = pd.read_csv \
        ('/Users/hua.zheng/Research/PHD/project/BN-MDP/BN/sd_s5a1-R15-explore0.3-v1-modelrisk--ntime36-sigma10.txt', header=None, dtype=np.float64)
    ...
    for id in range(1):
        ...
        feed_profile_ddpg = []
        np.random.seed(51 + id) # 111
        '''set up the time step and reward'''
        ...
        bio_env = fermentation_env(process_model, bn, time_measurement, real_measurement, m, b, c, params)
        ...
        '''
        simulate with new policy and existing policy with true model (ODEs)
        '''
        B = 50
    ...
    # np.save('./BN-MDP-psgd-fixed-outputs/final_titer-R8.npy', final_titer)
    # np.save('./BN-MDP-psgd-fixed-outputs/feed_profiles-R8.npy', feed_profiles)
    # np.save('./BN-MDP-psgd-fixed-outputs/total_feeding-R8.npy', total_feeding)
    # np.save('./BN-MDP-psgd-fixed-outputs/cumulative_rewards-R8.npy', cumulative_rewards)
